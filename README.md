...
[![GitHub Release](https://img.shields.io/github/v/release/glitch452/branch-release)](https://github.com/glitch452/branch-release/releases)
[![GitHub Marketplace](https://img.shields.io/badge/marketplace-branch--release-blue?logo=github)](https://github.com/marketplace/actions/branch-release)
...
| `disable-github-release`           | `boolean` | Create a GitHub Release. **Default:** `false`                                                                                                                                                                                                                                                                                             |
...
| `latest-tag-name`                  | `string`  | The tag used to track the latest commit on the release branch. **Default:** `'latest'`                                                                                                                                                                                                                                                    |
...
| `prepend-version-to-release-title` | `boolean` | Whether to prepend the release version to the release title. Note: this only applies when `get-release-title-from-pr` is `true`. **Default:** `false`                                                                                                                                                                                     |
